...
public class DBNadador  extends SQLiteOpenHelper {
    ...
    public DBNadador( Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            Log.e("DBNad.onCreateNadador", exc.getMessage());
        } finally {
            db.endTransaction();
        }
    }
    ...
    public void setNadador(Nadador nadador){
        ...
        try {
            ...
            Log.e("DBNad.insertarNadador", exc.getMessage());
        } finally {
            db.endTransaction();
        }
        db.close();
